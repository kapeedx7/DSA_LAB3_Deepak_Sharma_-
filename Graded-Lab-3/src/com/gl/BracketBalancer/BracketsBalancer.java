package com.gl.BracketBalancer;
...
public class BracketsBalancer {
	...
	public void check() {
		...
		for (int index = 0; index < length; index++) {
			...
			if (getOpenBrackets().contains(visitedChar)) {
				...
				System.out.println("Invalid characters encountered :" + visitedChar);
				break;
			}
		}
	...
	public static void main(String[] args) {
		...
		// Add the expression without spaces
		// Sample1
		...
		// Sample1 - [[{}]] - Bracket Expression Valid
		// Sample2 - ([{]) - Odd number of character - Invalid Expression.//Failed in
